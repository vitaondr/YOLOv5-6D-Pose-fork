...
#SBATCH --job-name=yolo6D_train_resume                               			# just to recognize the job in the queue overview
#SBATCH --nodes=1
...
#SBATCH --output=YOLOv5-6D-Pose-fork/runs/cls_train/yolo6D_train_resume.out   		    # standard output file
#SBATCH --error=YOLOv5-6D-Pose-fork/runs/cls_train/yolo6D_train_resume.out    		    # standard error file
...
COMMAND1="$PATH_TO_YOLO6D/resume_train.sh"
COMMAND1_OUT="$PATH_TO_YOLO6D/runs/cls_train/command1_resume.out"
